...
|--------|----------------|------------------|
| *Пример:* [Prompt Engineering  - один интрумент уровня бог для всех задач найма](https://example.com) | Всевышний дал знак | Очень прикладной, без воды, с готовыми шаблонами для рекрутёров |
|  |  |  |
|  |  |  |
|  |  |  |
